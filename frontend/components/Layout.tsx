...
const LogoIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-8 w-8 text-blue-600 dark:text-blue-400"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"></path><polyline points="3.5 12 8.5 12 10 10 12 14 14 10 15.5 12 20.5 12"></polyline></svg>
);
const LogoutIcon = () => (
    ...
    <>
      <div className="flex h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-100 dark:from-slate-900 dark:via-slate-900 dark:to-slate-800 overflow-hidden">
        ...
        <aside className="hidden lg:flex w-72 flex-shrink-0 flex-col bg-white dark:bg-slate-800 border-r border-slate-200/80 dark:border-slate-700/80 shadow-sidebar">
          ...
          {/* Sidebar Footer */}
          <div className="px-3 py-3 border-t border-slate-100 dark:border-slate-700/80">
            <button
